...
// Store results as global variables to prevent unwanted optimizations.
var path []int
var dist int64

func BenchmarkOptimizedShortestPath250(b *testing.B) {
	g, t := randomGraph(250)
	b.ResetTimer()
	var p []int
	var d int64
	for i := 0; i < b.N; i++ {
		p, d = OptimizedShortestPath(g, 0, t)
	}
	path, dist = p, d
}

func BenchmarkOptimizedShortestPath500(b *testing.B) {
	g, t := randomGraph(500)
	b.ResetTimer()
	var p []int
	var d int64
...
func BenchmarkOptimizedShortestPath1000(b *testing.B) {
